...
const feedPosts = [
  { av: 'OF', color: '#00aff0', name: 'OnlyFans', verified: true, handle: '@onlyfans', time: 'Hier', text: 'Ready to multiply your houseplants? @surfwithclaire walks you through the easiest pothos propagation ever—perfect for beginners and plant lovers alike. 🌿✨', hasVideo: true, likes: 1842, comments: 94 },
  { av: 'WD', color: 'linear-gradient(135deg,#00aff0,#0095cc)', name: 'Willy denz', verified: true, handle: '@u495354766', time: 'il y a 3 jours', text: "Nouvelle publication disponible pour mes abonnés ! 🔥 Merci pour votre soutien continu, ça compte énormément. N'hésitez pas à partager et à laisser un commentaire 💬", hasVideo: false, likes: 312, comments: 28 },
  { av: 'OF', color: '#ff6b35', name: 'OnlyFans Creators', verified: true, handle: '@creators', time: 'il y a 5 jours', text: "💡 Tip du jour : Publiez aux heures de pointe (18h–22h) pour maximiser votre visibilité. Les créateurs qui publient régulièrement voient une croissance de 3x plus rapide.", hasVideo: false, likes: 4721, comments: 382 },
  { av: 'WD', color: 'linear-gradient(135deg,#00aff0,#0095cc)', name: 'Willy denz', verified: true, handle: '@u495354766', time: 'il y a 1 semaine', text: 'Merci à tous mes fans pour ce premier mois incroyable ! 🙏 Je prépare du contenu exclusif qui arrive très bientôt. Restez connectés 🎉', hasVideo: false, likes: 156, comments: 42 },
];
    ...
    <div className="home-layout">
      <div className="home-center">
        ...
        <div className="home-header">
          <span className="home-header-title">ACCUEIL</span>
        ...
        <div className="home-composer">
          <div className="home-composer-input" contentEditable suppressContentEditableWarning data-placeholder="Ecrivez une nouvelle publication..." />
        ...
        <div className="home-filter-row">
          <div className={`home-filter-chip ${activeFilter === 'all' ? 'active' : ''}`} onClick={() => setActiveFilter('all')}>Tout</div>
        ...
        <div className="home-story-row">
          <div className="home-story-add">
            ...
            <div style={{ marginTop: 6, fontSize: 11, color: '#555', textAlign: 'center', fontWeight: 500 }}>Ajoutez en<br/>Story</div>
          </div>
        </div>
      ...
      <div className="home-right">
        ...
        <div className="profile-widget" style={{ marginBottom: 14 }}>
          <div className="profile-widget-body">
            <div style={{ fontSize: 11, fontWeight: 700, color: '#8a8a9a', letterSpacing: '.5px', marginBottom: 8 }}>ÉVÉNEMENTS PRÉVUS</div>
            <div style={{ fontSize: 12, color: '#666', lineHeight: 1.6, marginBottom: 14 }}>Vous pouvez désormais programmer des publications, messages et streams pour augmenter votre présence en ligne</div>
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '16px 0' }}>
              ...
              <div style={{ fontSize: 12, color: '#bbb', marginTop: 8 }}>Vous n'avez pas d'événements programmés.</div>
            </div>
          </div>
        </div>
