    ...
    <div className="queue-layout">
      <div className="queue-cal-panel">
        ...
        <div className="queue-month-nav">
          ...
          <span className="queue-month-label">{enMonths[calMonth]} {calYear}</span>
        </div>
        <div className="queue-type-chips">
          {['Posts', 'Messages'].map((c, i) => (
        ...
        <div className="queue-cal-grid">
          <div>
            {['M','T','W','T','F','S','S'].map((d, i) => (
              <span key={i} className="cal-day-header-item">{d}</span>
            ))}
          </div>
      ...
      <div className="queue-day-panel">
        <div className="queue-day-header">
          ...
          <span>{enMonths[calMonth]} {selectedDay}, {calYear}</span>
          <button className="queue-nav-btn">&gt;</button>
        </div>
        ...
        <div className="queue-day-empty">
          ...
          <div className="queue-day-empty-text">There are no scheduled events for this day</div>
        </div>
      </div>
    </div>
  );
